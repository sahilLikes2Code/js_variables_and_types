...
var a = prompt("What is your name mate?");
alert(`Welcome ${a}`);
...
var a = prompt("Input a sentence and i will magically tell you the number of characters it has");
var b = a.length;
alert(`It is comprised of ${b} characters`)
